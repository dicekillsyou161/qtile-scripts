...
keys = [
    ...
    Key([mod, "shift"], "k", lazy.layout.move_down(), desc="Move window down"),
    Key([mod, "shift"], "j", lazy.layout.move_up(), desc="Move window up"),
...
if str(primary_disp.get_prim_disp()) == "Disp" or str(primary_disp.get_prim_disp()) == "Virt":
    screens = [
        Screen(
            top=bar.Bar(
                [
